...
$q_page_object = get_post( $id );
$q_content = $q_page_object->post_content;
...
if($qode_options_elision['number_of_chars_large_image']) {
	qode_set_blog_word_count($qode_options_elision['number_of_chars_large_image']);
}
