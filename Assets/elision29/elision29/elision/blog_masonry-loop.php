		...
		<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			...
			<div class="post_text">
				<div class="post_description">
					<a class="post_author" target="_self" href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ) ); ?>"><?php the_author_meta('display_name'); ?></a>
					<?php echo '&nbsp;&nbsp;|&nbsp;&nbsp;  '; ?><?php the_category(', '); ?>
					<?php if($blog_hide_comments != "yes"){ ?><?php echo '&nbsp;&nbsp;|&nbsp;&nbsp;  '; ?><a class="post_comments" target="_self" href="<?php comments_link(); ?>"><?php comments_number( __('No comment','qode'), '1 '.__('Comment','qode'), '% '.__('Comments','qode') ); ?></a><?php } ?>
				</div>	
				<h3><a href="<?php the_permalink(); ?>" target="_self" title="<?php the_title_attribute(); ?>"><?php the_title(); ?></a></h3>
				<?php qode_excerpt(); ?>
				<a class="qbutton tiny" href="<?php the_permalink(); ?>" target="_self" title="<?php the_title_attribute(); ?>"><?php _e('Read More','qode'); ?></a>
		...
		<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			<div class="post_text">
				<div class="post_text_holder">
					...
					<div class="post_title">
						<h3><a href="<?php the_permalink(); ?>" target="_self" title="<?php the_title_attribute(); ?>"><?php echo get_post_meta(get_the_ID(), "quote_format", true); ?></a></h3>
