...
<div class="comment_number"><div class="comment_number_inner"><?php comments_number( __('No Comments','qode'), '<span>1</span>'.__('Comment','qode'), '<span> % </span>'.__('Comments','qode')); ?></div></div>
<div class="comments">
...
$args = array(
	...
	'title_reply'=>'<h3>'. __( 'Post A Comment','qode' ) .'</h3>',
