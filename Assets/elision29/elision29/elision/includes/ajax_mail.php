...
$use_captcha = $qode_options_elision['use_recaptcha'];
if ($resp->is_valid || $use_captcha == "no") {
?>success<?php

$email_to = $qode_options_elision['receive_mail'];
$email_from = $qode_options_elision['email_from'];
$subject = $qode_options_elision['email_subject'];
