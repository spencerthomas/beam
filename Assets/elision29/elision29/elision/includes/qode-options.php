						...
						<tr valign="middle">
							...
							<td>
								<select name="qode_options_elision[smooth_scroll]">
                                    ...
                                    <option <?php if(isset($options['smooth_scroll'])){ $smooth_scroll = $options['smooth_scroll']; if ($smooth_scroll == 'no_chrome_opera') { echo "selected='selected'"; } }  ?> value="no_chrome_opera">No (Chrome/Opera fix active)</option>
					...
					<tbody>
						...
						<tr>
							...
							<td>
								...
								<?php esc_html_e('Default value for initial background transparency is 0', 'qode'); ?>
							</td>
						</tr>
						<tr>
						...
						<tr>
							<td valign="middle" width="150"><?php esc_html_e('Logo animation on hover', 'qode'); ?></td>
							<td>
								<div class="inline">
									<select name="qode_options_elision[logo_animation]">
										<option <?php if(isset($options['logo_animation'])){ if ($options['logo_animation'] == "no") { echo "selected='selected'"; }} ?> value="no">No</option>
										<option <?php if(isset($options['logo_animation'])){ if ($options['logo_animation'] == "yes") { echo "selected='selected'"; }} ?> value="yes">Yes</option>	
									</select>
								</div>
							</td>
						</tr>
						...
						<tr>
							...
							<td>
								...
								<div class="inline">
									...
									<input name="qode_options_elision[footer_link_color]" type="text" value="<?php if (isset($options['footer_link_color'])) { echo esc_attr($options['footer_link_color'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									...
									<input name="qode_options_elision[footer_link_hover_color]" type="text" value="<?php if (isset($options['footer_link_hover_color'])){ echo esc_attr($options['footer_link_hover_color'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Background color', 'qode'); ?>
				...
				<table class="form-table">
					<tbody>
						...
						<tr valign="middle">
							...
							<td>
								<select name="qode_options_elision[portfolio_single_sidebar]">
						...
						<tr valign="middle">
							...
							<td>
								<select name="qode_options_elision[portfolio_single_sidebar_custom_display]">
                    ...
                    <tr valign="top">
                        ...
                        <td>
                            <div class="inline">
                                ...
                                <select name="qode_options_elision[enable_linkedin]">
                            ...
                            <div class="inline" style="width: 780px;">
                                <?php esc_html_e('Share Icon', 'qode'); ?>
                                <input type="text" id="linkedin_icon" name="qode_options_elision[linkedin_icon]" class="linkedin_icon" value="<?php if (isset($options['linkedin_icon'])) { echo esc_attr($options['linkedin_icon'], 'qode'); } ?>" size="70">
                                <input class="upload_button" type="button" value="Upload file">
                            </div>
                        </td>
                    </tr>
                    <tr valign="top">
                        ...
                        <td>
                            <div class="inline">
                                ...
                                <select name="qode_options_elision[enable_tumblr]">
                            ...
                            <div class="inline" style="width: 780px;">
                                ...
                                <input type="text" id="tumblr_icon" name="qode_options_elision[tumblr_icon]" class="tumblr_icon" value="<?php if (isset($options['tumblr_icon'])) { echo esc_attr($options['tumblr_icon'], 'qode'); } ?>" size="70">
                                <input class="upload_button" type="button" value="Upload file">
                            </div>
                        </td>
                    </tr>
                    <tr valign="top">
                        ...
                        <td>
                            <div class="inline">
                                ...
                                <select name="qode_options_elision[enable_pinterest]">
                            ...
                            <div class="inline" style="width: 780px;">
                                ...
                                <input type="text" id="pinterest_icon" name="qode_options_elision[pinterest_icon]" class="pinterest_icon" value="<?php if (isset($options['pinterest_icon'])) { echo esc_attr($options['pinterest_icon'], 'qode'); } ?>" size="70">
                                <input class="upload_button" type="button" value="Upload file">
                            </div>
                        </td>
                    </tr>
                    <tr valign="top">
                        ...
                        <td>
                            <div class="inline">
                                ...
                                <select name="qode_options_elision[enable_vk]">
                            ...
                            <div class="inline" style="width: 780px;">
                                ...
                                <input type="text" id="vk_icon" name="qode_options_elision[vk_icon]" class="vk_icon" value="<?php if (isset($options['vk_icon'])) { echo esc_attr($options['vk_icon'], 'qode'); } ?>" size="70">
                                <input class="upload_button" type="button" value="Upload file">
                            </div>
                        </td>
                    </tr>
