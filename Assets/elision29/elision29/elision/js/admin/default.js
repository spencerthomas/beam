...
$j(document).ready(function() {
	...
	var formfield;
	$j(document).on('click', '.brand_image,.slide_image,.portfolioimg,.logo_image,.logo_image_dark,.logo_image_sticky,.favicon_image,.background_image,.pattern_background_image,.loading_image,.title_image,.slide_thumbnail,.google_maps_pin_image,.facebook_icon,.twitter_icon,.google_plus_icon,.linkedin_icon,.tumblr_icon,.pinterest_icon,.vk_icon,.video_format_image', function(event) {
